...
[WooCommerce PagSeguro] (https://wordpress.org/plugins/woocommerce-pagseguro/) is a plugin that adds the PagSeguro gateway to WooCommerce and was developed by claudiosanches, Gabriel Reguly.

=== Ligações e créditos ===

[PagSeguro](https://pagseguro.uol.com.br/) é um método de pagamento brasileiro desenvolvido pela UOL.

[WooCommerce PagSeguro](https://wordpress.org/plugins/woocommerce-pagseguro/) é um plugin que adiciona o método de pagamento PagSeguro ao WooCommerce e foi desenvolvido por claudiosanches, Gabriel Reguly.
